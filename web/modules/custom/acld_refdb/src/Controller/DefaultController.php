<?php /**
 * @file
 * Contains \Drupal\acld_refdb\Controller\DefaultController.
 */
...
//    }
    ...
    $output = \Drupal::formBuilder()->getForm('Drupal\acld_refdb\Form\LibraryCardForm', $node);  // This is temp code - remove!
    /*
